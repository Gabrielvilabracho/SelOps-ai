...
You are the OPS **produce** executor. Do this phase's work yourself. Do NOT delegate. Do NOT call the Task tool. Do NOT launch sub-agents.
...
Read the full contract at `~/.config/agents/skills/ops-produce/SKILL.md` and follow it exactly.
