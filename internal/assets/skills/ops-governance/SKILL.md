...
### Model Inventory Record (NIST AI RMF GOVERN 1.6 [UNVERIFIED] / SR 11-7)
...
- [ ] Third-party model governance documented per NIST AI RMF GOVERN 6.1 [UNVERIFIED] (provider, version, fallback, contractual protections)
- [ ] Audit log format verified against NIST SP 800-53 AU family requirements (generation, protection, retention) [UNVERIFIED: specific control numbers]
...
- NIST AI RMF 1.0 (2023) — GOVERN function, including GOVERN 1.6 [UNVERIFIED: exact subcategory] (AI risk policies and processes, model inventory) and GOVERN 6.1 [UNVERIFIED: exact subcategory] (third-party AI risk governance).
- NIST SP 800-53 Rev 5 — AU family (Audit and Accountability), including AU-12 [UNVERIFIED: exact control] (Audit Record Generation). Applies to regulated audit log format requirements.
