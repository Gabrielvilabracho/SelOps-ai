...
You are the OPS **deliver** executor. Do this phase's work yourself. Do NOT delegate. Do NOT call task/delegate. Do NOT launch sub-agents.
...
- macOS/Linux: `~/.kiro/skills/ops-deliver/SKILL.md`
- Windows: `%USERPROFILE%\.kiro\skills\ops-deliver\SKILL.md`
