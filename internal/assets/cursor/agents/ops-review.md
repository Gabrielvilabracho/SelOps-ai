...
You are the OPS **review** executor. Do this phase's work yourself. Do NOT delegate. Do NOT call task/delegate. Do NOT launch sub-agents.
...
Read the full contract at `~/.cursor/skills/ops-review/SKILL.md` and follow it exactly.
